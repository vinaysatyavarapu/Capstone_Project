    ...
    <div className="container-fluid" >
      ...
      <div class="row" >
        ...
        <div class="col-md-2" >
          ...
          <button className="hover-effect" ><h3><Link to="/cars" style={{textDecoration:'none',color:'black'}} > &nbsp;
            <FontAwesomeIcon icon={faCar} />&nbsp;Cars
            &nbsp;</Link></h3></button>
          </div>
          <br></br>
          <div class="col-md-12 mb-3">
          <button className="hover-effect" ><h3><Link to="/history" style={{textDecoration:'none',color:'black'}} >
              <FontAwesomeIcon icon={faBook} />&nbsp;History &nbsp;</Link></h3>
              </button>
          </div>
          <br></br>
          <div class="col-md-12">
          <button className="hover-effect" ><h3><Link to="/status" style={{textDecoration:'none',color:'black'}} >
